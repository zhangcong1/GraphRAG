...
exports.COLLECTION_LIMIT_MESSAGE = exports.MilvusRestfulVectorDatabase = void 0;
/**
...
async function createCollectionWithLimitCheck(makeRequestFn, collectionSchema) {
    try {
        ...
        if (/exceeded the limit number of collections/i.test(errorMessage)) {
            ...
            throw exports.COLLECTION_LIMIT_MESSAGE;
        }
        // Re-throw other errors as-is
        throw error;
    }
}
//# sourceMappingURL=milvus-vectordb-stub.js.map